...
import detalles.ConvertirDate_a_String;

public class Cliente extends Persona implements Serializable {

    //Máximo 10 tarjetas por cliente
    private ArrayList<Tarjeta> tarjetas;
    private boolean movViaje;//Signifca que un cliente está actualmente en un viaje o no
